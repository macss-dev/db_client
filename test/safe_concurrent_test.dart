...
void main() {
  test('✓ 5 conexiones concurrentes (test conservador)', () async {
      ...
      final future = Future(() async {
        ...
        try {
          ...
          if (!response.success) {
            ...
            stdout.writeln('[$i] ✓ Query exitosa - connection_id: $connectionId, timestamp: $timestamp');
          }
          
          expect(response.success, isTrue, reason: 'Query $i falló. Error: ${response.error}');
